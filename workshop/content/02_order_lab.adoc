...
. After provisioning is complete you'll get an email with the login details. 

. You are now ready to configure follow through the exercises and deploy Red Hat Quay on RHEL.
